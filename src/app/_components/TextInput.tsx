...
const textInputStyles = tv({
  slots: {
    labelStyle: 'mb-2 block text-sm font-semibold text-gray-900',
    inputStyle:
      'block h-12 w-full rounded-lg border border-gray-300 bg-gray-50 px-4 text-base tracking-wide text-gray-900 focus:border-blue-500 focus:ring-blue-500',
    errorStyle: 'mt-2 text-sm font-medium text-red-600',
  },
  variants: {
    disabled: {
      true: 'block h-12 w-full cursor-not-allowed rounded-lg border border-gray-300 bg-gray-100 px-4 text-base text-gray-900 focus:border-blue-500 focus:ring-blue-500',
    },
    error: {
      true: {
