...
export const CreateEventCard: React.FC = () => {
  ...
  return (
    <Card
      ...
      className='flex min-h-[100px] max-w-[1080px] cursor-pointer items-center justify-center rounded-[15px] border border-[#e9e9e9] bg-white p-6 transition hover:bg-gray-100 hover:shadow-md active:bg-gray-200 md:min-h-[121px] md:py-[9px]'
    >
